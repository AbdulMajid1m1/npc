...
const MemberRegistration = ({ title }) => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center -mt-5">
        <div className="w-[97%] bg-[#E6F6F8] shadow-xl rounded-md p-6">
          ...
          <div className="flex justify-end items-end mt-6 mb-6 px-5">
            <button className="bg-[#01B5FB] sm:w-[25%] text-white font-medium px-6 py-3 rounded hover:bg-blue-600">
              Next
            </button>
          </div>
    </div>
